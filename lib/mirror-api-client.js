...
/**
 * Get settings
 * @param {Object} settingsId - settings identifier
**/
MirrorClient.prototype.getSettings = function(settingsId, cb){
    if(typeof settingsId === 'object' && 'id' in settingsId) settingsId = settingsId.id;
    if(settingsId !== 'locale' && settingsId !== 'timezone') settingsId = 'timezone';
    this.mirror
        .settings
        .get({ id: settingsId })
        .withAuthClient( this.oauth2Client )
